...
const generateBackgroundColorTokens = (scale: any, grayScale: any): any => {
  ...
  const filledButtonBackgroundColor = {
    ...
    'background-button-filled-primary-active': genericScale[200],
  ...
  const outlinedButtonBackgroundColor = {
    'background-button-outlined-primary-normal': '$transparent',
    'background-button-outlined-primary-hover': genericScale[20],
    'background-button-outlined-primary-active': genericScale[30],
    'background-button-outlined-primary-focused': genericScale[40],
  ...
  const textButtonBackgroundColor = {
    ...
    'background-button-text-primary-active': genericScale[30],
...
const generateBorderColorTokens = (scale: any, grayScale: any): any => {
  ...
  const outlinedButtonBorderColor: any = {
    'border-button-outlined-primary-normal': genericGrayScale[90],
    'border-button-outlined-primary-hover': genericGrayScale[200],
    'border-button-outlined-primary-active': genericGrayScale[300],
...
const generateTextColorTokens = (scale: any, grayScale: any): any => {
  ...
  const filledButtonTextColor: any = {
    ...
    'text-button-filled-primary-active': genericScale[30],
  ...
  const outlinedButtonTextColor: any = {
    ...
    'text-button-outlined-primary-active': genericScale[90],
  ...
  const textButtonTextColor: any = {
    ...
    'text-button-text-primary-active': genericScale[100],
