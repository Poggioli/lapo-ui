...
const generateTextColorTokens = (scale: any, grayScale: any, errorScale: any): any => {
    ...
    const textColors: any = {
        'text-input-filled-primary-label-normal': genericGrayScale[100],
        ...
        'text-input-filled-primary-input-value-normal': genericGrayScale[200],
        ...
        'text-input-outlined-primary-label-normal': genericGrayScale[100],
        ...
        'text-input-outlined-primary-input-value-normal': genericGrayScale[200],
